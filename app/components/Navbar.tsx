    ...
    >
      <div className="container mx-auto px-6 md:px-4">
        <div className="flex items-center justify-between">
          ...
          <motion.a
            href="#inicio"
            className="text-2xl font-serif font-semibold text-text-main hover:text-primary transition-colors"
        ...
        <AnimatePresence>
          {isMobileMenuOpen && (
            <motion.div
              ...
              className="md:hidden mt-4 glass-strong rounded-2xl overflow-hidden z-50"
            >
